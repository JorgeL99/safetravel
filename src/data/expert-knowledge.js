...
export const expertDestinations = [
  ...
  {
    id: "cusco", name: "Cusco y Machu Picchu", naturalRegion: "Sierra", department: "Cusco",
  ...
  {
    id: "arequipa", name: "Arequipa y Valle del Colca", naturalRegion: "Sierra", department: "Arequipa",
  ...
  {
    id: "puno", name: "Puno y Lago Titicaca", naturalRegion: "Sierra", department: "Puno",
  ...
  {
    id: "ancash", name: "Áncash y Cordillera Blanca", naturalRegion: "Sierra", department: "Áncash",
  ...
  {
    id: "loreto", name: "Iquitos y Pacaya Samiria", naturalRegion: "Selva", department: "Loreto",
  ...
  {
    id: "tambopata", name: "Tambopata", naturalRegion: "Selva", department: "Madre de Dios",
